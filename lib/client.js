...
Client.prototype.connect = function(callback){
  ...
  //poll for connections that need to be reconnected
  this.reconnectTimer = setTimeout(_.bind(this.reconnect, this), 500);
...
Client.prototype.reconnect = function(){
  ...
  var pruned = false;
  //console.log('polling for reconnects');
  ...
  for(var i=0;i<this.connections.length;i++){
    ...
    //console.log(conn.triggerReconnect);
